...
dictionary = {'Mutable': 'Values can be changed just like a list.',
              'Immutable': 'Values can not be changed just like tuple.',
...
button_mutable = Button(root, text = "Meaning of Mutable", command = mutable, bg="Black",fg="white")
button_mutable.place(relx =0.5, rely =0.2, anchor = CENTER)

label_of_mutable.place(relx = 0.5, rely = 0.3, anchor = CENTER)

button_immutable = Button(root, text = "Meaning of Immutable", command = immutable, bg="Black",fg="white")
button_immutable.place(relx =0.5, rely =0.4, anchor = CENTER)

label_of_immutable.place(relx = 0.5, rely = 0.5, anchor = CENTER)

button_tkinter = Button(root, text = "Meaning of Tkinter", command = tkinter, bg="Black",fg="white")
